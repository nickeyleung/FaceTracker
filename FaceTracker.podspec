#
#  Be sure to run `pod spec lint FaceTracker.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "FaceTracker"
  spec.version      = "0.0.1"
  spec.summary      = "tracking face and add sticker image on it"
  ...
  spec.author             = "Leung"
  # Or just: spec.author    = "Leung"
  # spec.authors            = { "Leung" => "" }
  # spec.social_media_url   = "https://twitter.com/Leung"
